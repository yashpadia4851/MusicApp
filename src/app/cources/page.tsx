...
import corcesData from '@/data/music_courcesdata.json'
...
function ThreeDCardDemo() {
  return (
    <div className="min-h-screen bg-black py-12 pt-36 ">
      <h1 className="text-center text-lg md:text-7xl font-sans font-bold text-white mb-8">All Courses ({corcesData.courses.length}) </h1>
